...
<br>
						...
						<div class="col-md-12">
							 <button class='class=" btn btn-block btn-LG bg_icons-highpurple botones_cel" >' data-bs-toggle="modal" data-bs-target="#buscar_productos" >Agregar Productos <i class="bi bi-cart-plus-fill"></i></button>
								<!-- <button type="submit" class=" btn btn-block btn-LG bg_icons-highpurple botones_cel" > Agregar Productos  <i class="bi bi-arrow-right-circle-fill"></i> -->
								<button type="submit" class=" btn btn-block btn-LG g-label-success botones_cel" > Guardar <i class="bi bi-floppy2"></i>	</button>				
								<!-- <button type="submit" class=" btn btn-block btn-LG bg_icons-orange botones_cel" > SIGUIENTE  <i class="bi bi-arrow-right-circle-fill"></i> -->
								</button> 
