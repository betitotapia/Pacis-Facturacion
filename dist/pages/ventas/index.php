    ...
    ?>
		...
		?>
			...
			?>
                    ...
                    <h4><i class='glyphicon glyphicon-search' onkeyup='load(1);'></i>Remisiones</h4>
			...
			?>
                    <div class="boton_new" >
                        <a class='btn btn-lg btn-success'  onclick=nueva_remision();> Nueva Remisión <i
                    ...
                    <form class="form-horizontal" role="form" id="datos_cotizacion">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="hidden" class="form-control" id="q"
                                    placeholder="Nombre del cliente o # de Remisión" onkeyup='load(1);'>
                            </div>
                            <div class="outer-div">
...
include("../footer.php");
    ...
    <script type="text/javascript" src="../../js/remisiones.js"> </script>
...
function nueva_remision() {
    $.ajax({
        ...
        success: function(data) {
            ...
            window.location.href = "editar_remision_scliente.php?id_factura=" +
            data; // Redirige a la página de nueva remisión
        },
